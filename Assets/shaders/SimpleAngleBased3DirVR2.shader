    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_7432 = (sin(node_4430)*2.0+-1.0);
                v.vertex.xyz += (node_7432*_node_8292.rgb);
