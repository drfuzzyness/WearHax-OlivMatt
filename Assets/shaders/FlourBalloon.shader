...
/////// Vectors:
                clip((i.posWorld.b*-0.1+1.0) - 0.5);
////// Lighting:
////// Emissive:
                float3 emissive = floor(lerp(_node_9711.rgb,_Color.rgb,(_node_8430*(i.posWorld.b*_ZposScale))) * _node_9041) / (_node_9041 - 1);
