...
////// Lighting:
////// Emissive:
                float3 emissive = floor(lerp(_col2.rgb,_col1.rgb,(_node_8430*(i.posWorld.g*_ZposScale))) * _node_9041) / (_node_9041 - 1);
