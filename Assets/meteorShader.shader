    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_7295 = ((((1.0 - pow(_t2_var.b,100.0))*pow(_t3_var.rgb,3.0))*10.0)*_node_459.rgb);
